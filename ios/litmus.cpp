...
int runTest()
{
    ...
    cout<< "trying to execute this ";
    
    string testName = "store";
    string shaderFile = "litmustest_store_default";
    
    string resultShaderFile = "litmustest_store_results";
    
    string configFile = "parameters_basic.txt";
    
    string filePath = "/Users/atom/Downloads/Android-Vulkan-Memory-Model-Testing-main/app/src/main/res/raw/";
    
    std::ofstream outputFile;
    string outputFilePath = "/Users/atom/iosapp/ios/output.txt";
  //  string outputFilePath = filePath +  "/" + "output.txt";
    outputFile.open(outputFilePath);
